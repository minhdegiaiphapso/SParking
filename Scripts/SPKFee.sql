CREATE DATABASE  IF NOT EXISTS `spkfee` /*!40100 DEFAULT CHARACTER SET utf8mb3 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `spkfee`;
-- MySQL dump 10.13  Distrib 8.0.43, for Win64 (x86_64)
--
-- Host: localhost    Database: spkfee
-- ------------------------------------------------------
...
-- Dump completed on 2025-10-12 10:44:40
