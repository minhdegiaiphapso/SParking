CREATE DATABASE  IF NOT EXISTS `spk` /*!40100 DEFAULT CHARACTER SET utf8mb3 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `spk`;
...
CREATE TABLE `gatenotified` (
  `id` int NOT NULL AUTO_INCREMENT,
  `blackliststate` int DEFAULT NULL,
...
--
-- Table structure for table `lockcard`
--

DROP TABLE IF EXISTS `lockcard`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `lockcard` (
  `card_label` varchar(128) NOT NULL,
  PRIMARY KEY (`card_label`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `parking_apartment` (
  ...
  `bike_slot` int NOT NULL DEFAULT '0',
...
--
-- Table structure for table `parking_baseline_available_slot`
--

DROP TABLE IF EXISTS `parking_baseline_available_slot`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `parking_baseline_available_slot` (
...
--
-- Table structure for table `parking_baseline_transaction_in`
--

DROP TABLE IF EXISTS `parking_baseline_transaction_in`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `parking_baseline_transaction_in` (
  `id` varchar(45) NOT NULL,
  `check_in_time_day` varchar(15) DEFAULT NULL,
  `check_in_time_week` varchar(15) DEFAULT NULL,
  `check_in_time_month` varchar(8) DEFAULT NULL,
  `check_in_time_year` varchar(6) DEFAULT NULL,
  `vehicle_type` int NOT NULL,
  `transaction_count` int NOT NULL DEFAULT '0',
  `guest_transaction_count` int DEFAULT '0',
  `registered_transaction_count` int DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `parking_baseline_transaction_out`
--

DROP TABLE IF EXISTS `parking_baseline_transaction_out`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `parking_baseline_transaction_out` (
  `id` varchar(45) NOT NULL,
  `check_out_time_day` varchar(15) DEFAULT NULL,
  `check_out_time_week` varchar(15) DEFAULT NULL,
  `check_out_time_month` varchar(8) DEFAULT NULL,
  `check_out_time_year` varchar(6) DEFAULT NULL,
  `vehicle_type` int NOT NULL,
  `transaction_count` int NOT NULL DEFAULT '0',
...
CREATE TABLE `parking_blockfee` (
  `id` int NOT NULL AUTO_INCREMENT,
  `parking_fee_id` int NOT NULL,
  `first_block_duration` int NOT NULL,
  `next_block_duration` int NOT NULL,
  `first_block_fee` int NOT NULL,
  `next_block_fee` int NOT NULL,
  `max_block_duration` int NOT NULL,
  `max_block_fee` int NOT NULL,
  `in_day_block_fee` int NOT NULL,
  `night_block_fee` int NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `parking_claimpromotion` (
  ...
  `user_id` int NOT NULL,
  `parking_session_id` int NOT NULL,
  `amount_a` int NOT NULL,
  `amount_b` int NOT NULL,
  `amount_c` int NOT NULL,
  `amount_d` int NOT NULL,
  `amount_e` int NOT NULL,
...
CREATE TABLE `parking_claimpromotion_logerror` (
  ...
  `amount_a` int DEFAULT NULL,
  `amount_b` int DEFAULT NULL,
  `amount_c` int DEFAULT NULL,
  `amount_d` int DEFAULT NULL,
  `amount_e` int DEFAULT NULL,
...
CREATE TABLE `parking_claimpromotionbillv2` (
  `id` int NOT NULL AUTO_INCREMENT,
  `claim_promotion_id` int DEFAULT NULL,
...
CREATE TABLE `parking_customer` (
  ...
  `customer_avatar` varchar(100) DEFAULT NULL,
  `customer_phone` varchar(255) DEFAULT NULL,
  `customer_mobile` varchar(255) DEFAULT NULL,
  `customer_email` varchar(255) DEFAULT NULL,
  `order_register_name` varchar(100) DEFAULT NULL,
  `order_register_address` varchar(200) DEFAULT NULL,
  `order_tax_code` varchar(50) DEFAULT NULL,
  `messaging_via_sms` tinyint(1) DEFAULT NULL,
  `messaging_via_phone` tinyint(1) DEFAULT NULL,
  `messaging_via_email` tinyint(1) DEFAULT NULL,
  `messaging_via_apart_mail` tinyint(1) DEFAULT NULL,
  `messaging_via_wiper_mail` tinyint(1) DEFAULT NULL,
  `messaging_sms_phone` varchar(255) DEFAULT NULL,
  `messaging_phone` varchar(255) DEFAULT NULL,
  `messaging_email` varchar(255) DEFAULT NULL,
  `messaging_address` varchar(255) DEFAULT NULL,
...
CREATE TABLE `parking_depositpaymentdetail` (
  ...
  `vehicle_registration_id` int DEFAULT NULL,
  `vehicle_number` varchar(255) NOT NULL,
  `deposit_action_fee_id` int DEFAULT NULL,
  `deposit_payment_detail_fee` int NOT NULL,
  PRIMARY KEY (`id`),
...
--
-- Table structure for table `parking_epassapi`
--

DROP TABLE IF EXISTS `parking_epassapi`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `parking_epassapi` (
  `id` int NOT NULL AUTO_INCREMENT,
  ...
  `c_headers` longtext,
  `c_method` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `c_partner_refs_id_0d968ddc_idx` (`c_partner`),
  CONSTRAINT `c_partner_refs_id_0d968ddc` FOREIGN KEY (`c_partner`) REFERENCES `parking_epasspartner` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `parking_epasscollected`
--

DROP TABLE IF EXISTS `parking_epasscollected`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `parking_epasscollected` (
  `id` int NOT NULL,
  `epc` varchar(50) DEFAULT NULL,
  `vehiclenumber` varchar(50) DEFAULT NULL,
  `platecolor` tinyint(1) DEFAULT '0',
...
--
-- Table structure for table `parking_epasspartner`
--

DROP TABLE IF EXISTS `parking_epasspartner`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `parking_epasspartner` (
  `id` int NOT NULL AUTO_INCREMENT,
  `partnercode` varchar(128) NOT NULL,
  `parkingcode` varchar(45) NOT NULL,
  `activated` tinyint(1) NOT NULL DEFAULT '0',
  `loginrequest` longtext,
  `loginresponse` longtext,
  `loginsuccess` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `parking_epassprefixcheck`
--

DROP TABLE IF EXISTS `parking_epassprefixcheck`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `parking_epassprefixcheck` (
  `id` int NOT NULL AUTO_INCREMENT,
  `prefixcode` varchar(34) NOT NULL,
  `description` varchar(256) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `prefixcode_UNIQUE` (`prefixcode`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `parking_mobileshift`
--

DROP TABLE IF EXISTS `parking_mobileshift`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `parking_mobileshift` (
  `id` int NOT NULL AUTO_INCREMENT,
  `app_id` varchar(128) NOT NULL,
  `staff_login` varchar(128) NOT NULL,
  `from_time` datetime NOT NULL,
  `to_time` datetime DEFAULT NULL,
  `total_in` int NOT NULL DEFAULT '0',
  `total_out` int NOT NULL DEFAULT '0',
  `total_car_in` int NOT NULL DEFAULT '0',
  `total_car_out` int NOT NULL DEFAULT '0',
  `total_bicycle_in` int NOT NULL DEFAULT '0',
  `total_bicycle_out` int NOT NULL DEFAULT '0',
  `total_visitor_in` int NOT NULL DEFAULT '0',
  `total_visitor_out` int NOT NULL DEFAULT '0',
  `total_monthly_in` int NOT NULL DEFAULT '0',
  `total_monthly_out` int NOT NULL DEFAULT '0',
  `total_fee` int NOT NULL DEFAULT '0',
  `total_actual_fee` int DEFAULT NULL,
  `ajustment_fee` int DEFAULT NULL,
...
CREATE TABLE `parking_parkingfee` (
  ...
  `min_calculation_time` int NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `parking_parkingsession` (
  ...
  `check_in_operator_id` int NOT NULL,
  `check_in_time` datetime NOT NULL,
  `check_in_images` longtext NOT NULL,
  `check_in_lane_id` int NOT NULL,
  `check_out_alpr_vehicle_number` varchar(20) DEFAULT NULL,
  `check_out_operator_id` int DEFAULT NULL,
  `check_out_time` datetime DEFAULT NULL,
  `check_out_images` longtext,
  `check_out_lane_id` int DEFAULT NULL,
  `duration` int DEFAULT NULL,
  `check_out_exception_id` int DEFAULT NULL,
...
CREATE TABLE `parking_slot` (
  ...
  `numlength` int DEFAULT NULL,
  `hascheckkey` int DEFAULT NULL,
  `slottotal` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `parking_terminal` (
  ...
  `terminal_group_id` int DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `parking_ticketpaymentdetail` (
  `id` int NOT NULL AUTO_INCREMENT,
  `ticket_payment_id` int NOT NULL,
  `vehicle_registration_id` int DEFAULT NULL,
  `vehicle_number` varchar(255) NOT NULL,
  `level_fee` int NOT NULL,
  `effective_date` date DEFAULT NULL,
  `duration` int NOT NULL,
  `day_duration` int NOT NULL,
  `old_expired_date` date DEFAULT NULL,
  `expired_date` date DEFAULT NULL,
  `payment_detail_fee` int NOT NULL,
  `used` tinyint(1) NOT NULL,
...
CREATE TABLE `parking_turnfee` (
  ...
  `day_fee` int NOT NULL,
  `night_fee` int NOT NULL,
...
CREATE TABLE `parking_vehiclebalcklist` (
  ...
  CONSTRAINT `parking_vehiclebalcklist_ibfk_1` FOREIGN KEY (`vehicle_type`) REFERENCES `parking_vehicletype` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `unlockcard`
--

DROP TABLE IF EXISTS `unlockcard`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `unlockcard` (
  `card_id` varchar(45) NOT NULL,
  `card_label` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`card_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Temporary view structure for view `vw_parking_fee_session`
--

DROP TABLE IF EXISTS `vw_parking_fee_session`;
/*!50001 DROP VIEW IF EXISTS `vw_parking_fee_session`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vw_parking_fee_session` AS SELECT 
 1 AS `card_type`,
 1 AS `vehicle_type_id`,
 1 AS `session_type`,
 1 AS `parking_fee`,
 1 AS `ex_checkout_id`,
 1 AS `calculation_time`,
 1 AS `check_out_operator_id`,
 1 AS `ex_parking_fee`*/;
SET character_set_client = @saved_cs_client;

--
-- Dumping routines for database 'hd'
--
...
begin
	select * 
    from parking_vehiclebalcklist
    where  length((replace(replace(replace(replace(vnum,'-',''),'_',''),'.',''),' ','')))>=4 and
		((replace(replace(replace(replace(vehicle_number,'-',''),'_',''),'.',''),' ','')) like concat('%',(replace(replace(replace(replace(vnum,'-',''),'_',''),'.',''),' ','')) ))
		or ((replace(replace(replace(replace(vnum,'-',''),'_',''),'.',''),' ','')) like concat('%',(replace(replace(replace(replace(vehicle_number,'-',''),'_',''),'.',''),' ','')) ) )
    ;
end ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
CREATE  PROCEDURE `forcedbariersave`(
	username varchar(50),lane varchar(128), pcaddress varchar(128),timestp long,front varchar(256),back varchar(256),fdate datetime
)
begin
	insert into `parking_forcedbarier`(`user`,`lan`,`teminal`,`timestampe`,`frontpath`,`backpath`,`forcedtime`)
    values(username,lane,pcaddress,timestp,front,back,fdate);
end ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
begin
	Select p.id, DATE_FORMAT(p.`date`,'%d/%m/%Y %H:%i:%s') as `parkingdate` , b.vehicle_number,v.`name` as `vehicle_type`, t.`name` as `gate`, u.fullname as `user`,
		case when p.stateparking = 0 then 'Check_In' else 'Check_Out' end `staeParking` ,p.notes,p.parking_id,p.image_path
    ...
    where 
        ...
        not exists (select 1 from gatenotified g where  g.blackliststate=p.id and g.gatereceive=gatename)
	order by p.`date` desc;
    insert into `gatenotified`(blackliststate,gatereceive)
    select p.id,gatename
    from parking_currentbalckliststate p
	where 
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `getcheckin_report` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb3 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE  PROCEDURE `getcheckin_report`(ftime datetime, tdate datetime)
begin
	set ftime=DATE_SUB(ftime,interval 7 hour);
    set tdate=DATE_SUB(tdate,interval 7 hour);
    select concat(v.name, ' tháng') as `month_checkin`, checkinamount(ftime, tdate, v.id,1) as `amount_month`,concat(v.name, ' vãng lai') as `vl_checkin`, checkinamount(ftime, tdate, v.id,0) as `amount`
    from parking_vehicletype v
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `getcheckout_report` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb3 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE  PROCEDURE `getcheckout_report`(ftime datetime, tdate datetime)
begin
	set ftime=DATE_SUB(ftime,interval 7 hour);
    set tdate=DATE_SUB(tdate,interval 7 hour);
    select concat(v.name, ' tháng') as `month_checkout`, checkoutamount(ftime, tdate, v.id,1) as `quatity_month`,concat(v.name, ' vãng lai') as `vl_checkout`, checkoutamount(ftime, tdate, v.id,0) as `quantity`, checkoutsumamount(ftime, tdate, v.id) as `amount`, null as `dc`, null as `pn`, null as `remark`
    from parking_vehicletype v
    where v.id!=100000000;
end ;;
DELIMITER ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `getregismonth` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb3 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE  PROCEDURE `getregismonth`(fdate date, tdate date)
begin
	select t.*
    from
    (
	select pr.customer_id, ct.name as `customertype`, c.customer_name ,vt.id as `vehicletype_id`, vt.name as `vehiceltype`, l.fee as `feepermonth`,
		case when pr.start_date<=fdate then 
			case when pr.expired_date >= fdate then
				case when pr.cancel_date is not null and pr.cancel_date< fdate then null else fdate end
				else null end
            else 
				case when pr.start_date> tdate then null else pr.start_date end 
			end as `fromdate`,
		case when pr.expired_date>=tdate then
			case when pr.cancel_date is not null and pr.cancel_date<tdate  then pr.cancel_date 
				else tdate end
			else
				case when pr.cancel_date is not null then pr.cancel_date 
					else pr.expired_date end
			end as `todate`
                    
    from parking_vehicleregistration pr
    left join parking_customer c on c.id=pr.customer_id
    left join parking_customertype ct on ct.id=c.customer_type_id
    left join parking_levelfee l on l.id=pr.level_fee_id
    left join parking_vehicletype vt on vt.id=l.vehicle_type_id
    ) t
    where t.fromdate is not null and t.todate is not null and t.fromdate<= t.todate
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `getregismonth_report` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb3 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE  PROCEDURE `getregismonth_report`()
begin
	select c.id, ct.name ,c.customer_name
    from  parking_customer c
    inner join parking_customertype ct on ct.id=c.customer_type_id
    order by ct.name,c.customer_name;
end ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
    ...
    (
		...
		(
			select cr.`card_label` as 'card',c.`customer_name` as `customer`,t.`name` as `vehecletype`, v.vehicle_number,v.vehicle_brand,v.vehicle_driver_name,
				...
				case v.`status` 
					when 0 then 'Hủy'
					when 1 then 'Ðang dùng'
					when 2 then 'Tạm ngừng'
					when 3 then 'Chưa đăng ký'
					else  '' end
				as `status`,
			...
			where v.customer_id=cus and dt.duration is not null and  dt.duration>0
...
begin
    ...
    (
		select @rownum:=@rownum + 1 as `Row_Number` , t.id,c.card_id,c.card_label,c.card_type,p.vehicle_type,p.vehicle_number,
			...
			p.check_out_images,p.check_in_time,p.check_out_time,p.check_in_lane_id,p.check_out_lane_id
		from
		(
			select p.id
			from parking_parkingsession p
        ...
        left join parking_card c on c.id=p.card_id
        where ifnull(cardlabel,'')='' or c.card_label=cardlabel 
    )tt 
...
begin
	select pv.id, pv.vehicle_number,pc.card_label,pt.name as `vehicletype`,
		case pv.status when 0 then 'Hủy' when 1 then 'Đang dùng' when 2 then 'Tạm dừng' when 3 then 'Chưa đăng ký' else '' end as `status`,
    ...
    where pv.customer_id=cus and pv.status in (1,3);
...
--
-- Final view structure for view `vw_parking_fee_session`
--
...
/*!50001 VIEW `vw_parking_fee_session` AS select `p0`.`card_type` AS `card_type`,`pfs`.`vehicle_type_id` AS `vehicle_type_id`,`pfs`.`session_type` AS `session_type`,`pfs`.`parking_fee` AS `parking_fee`,0 AS `ex_checkout_id`,`pfs`.`calculation_time` AS `calculation_time`,`ps`.`check_out_operator_id` AS `check_out_operator_id`,0 AS `ex_parking_fee` from ((`parking_parkingfeesession` `pfs` join `parking_parkingsession` `ps` on((`pfs`.`parking_session_id` = `ps`.`id`))) join `parking_card` `p0` on((`pfs`.`card_id` = `p0`.`card_id`))) union all select `p0`.`card_type` AS `card_type`,`pfs`.`vehicle_type_id` AS `vehicle_type_id`,'OUT' AS `session_type`,0 AS `parking_fee`,`pe`.`id` AS `ex_checkout_id`,`pfs`.`calculation_time` AS `calculation_time`,`ps`.`check_out_operator_id` AS `check_out_operator_id`,`pe`.`parking_fee` AS `ex_parking_fee` from (((`parking_parkingfeesession` `pfs` join `parking_parkingsession` `ps` on(((`pfs`.`parking_session_id` = `ps`.`id`) and (`pfs`.`session_type` = 'IN')))) join `parking_card` `p0` on((`pfs`.`card_id` = `p0`.`card_id`))) join `parking_checkoutexceptioninfo` `pe` on((`ps`.`check_out_exception_id` = `pe`.`id`))) */;
...
-- Dump completed on 2025-10-12 10:37:32
