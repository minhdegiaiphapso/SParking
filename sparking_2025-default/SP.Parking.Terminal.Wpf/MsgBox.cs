...
namespace SP.Parking.Terminal.Wpf
{
    public class MsgBox : Form
    {
        ...
        private MsgBox()
        {
            ...
            //this.BackColor = Color.FromArgb(55, 189, 176);
            ...
            _lblTitle.ForeColor = Color.FromArgb(55, 189, 176);//49, 142, 204
            ...
            _lblMessage.ForeColor = Color.FromArgb(55, 189, 176);//49, 142, 204
            ...
            _plFooter.BackColor = Color.FromArgb(55, 189, 176);//49, 142, 204
            _plFooter.Height = 80;
            _plFooter.Controls.Add(_flpButtons);

            _picIcon.Width = 70;
            _picIcon.Height = 70;
            _picIcon.Location = new Point(8, 30);
        ...
        private static void InitButtons(Buttons buttons)
        {
            ...
            {
                //btn.ForeColor = Color.FromArgb(49, 142, 204);
                btn.BackColor = Color.FromArgb(55, 189, 176);
        ...
        private static void InitIcon(Icon icon)
        {
            switch (icon)
            {
                ...
                case MsgBox.Icon.Info:
                    _msgBox._picIcon.SizeMode = PictureBoxSizeMode.Zoom;
                    _msgBox._picIcon.Image = Properties.Resources.info_icon;
                    break;

                case MsgBox.Icon.Question:
                    _msgBox._picIcon.SizeMode = PictureBoxSizeMode.Zoom;
                    _msgBox._picIcon.Image = Properties.Resources.question_icon;
                    break;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            Pen pen = new Pen(Color.FromArgb(55, 189, 176));
